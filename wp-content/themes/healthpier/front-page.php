        ...
        <section class="benefits">
            <div class="container">
                <div class="benefits-icons">
                    ...
                    <circle cx="30" cy="30" r="29.5" transform="matrix(-1 0 0 1 830 457)" stroke="#235189"/>
                    <path d="M812.414 487H787.586M787.586 487L794.12 480.793M787.586 487L794.12 493.207" stroke="#235189"/>
                </svg>
                            ...
                            <div class="news-card">
                                ...
                                <div class="news-card__block">
                                    ...
                                    <div class="news-card__text">
                                        ...
                                        $trimmed_content = wp_trim_words($post_content, 23, '...');
